...
import PaymentDetailsManager from "@/components/payment-details-manager"
      ...
      <main className="min-h-screen bg-gradient-to-b from-green-50 to-white py-6 sm:py-12 px-3 sm:px-4">
        <div className="container mx-auto">
          <div className="text-center mb-6 sm:mb-12">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-green-700">Detail Pembayaran</h2>
          </div>
